...
export const fetchCells = () => {
  return async (dispatch: Dispatch<Action>) => {
    ...
    try {
      ...
      dispatch({ type: ActionType.FETCH_CELLS_SUCCESS, payload: data });
    } catch (err: any) {
      dispatch({ type: ActionType.FETCH_CELLS_FAILED, payload: err.message });
    }
  };
};
...
export const saveCells = () => {
  return async (dispatch: Dispatch<Action>, getState: () => RootState) => {
    ...
    try {
      ...
      dispatch({ type: ActionType.SAVE_CELLS_FAILED, payload: err.message });
    }
  };
};
